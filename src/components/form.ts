...
export const primaryBtn =
  "w-full rounded-xl bg-gold px-4 py-3 text-sm font-semibold text-ink hover:bg-gold-strong disabled:opacity-50";

export const ghostBtn =
  "w-full rounded-xl border border-line2 px-4 py-3 text-sm font-medium text-paper hover:border-gold/60 disabled:opacity-50";

export const cardCls =
  "w-full rounded-2xl border border-line bg-surface p-6 sm:p-8";
